...
| <a name="input_kms_key_arn"></a> [kms\_key\_arn](#input\_kms\_key\_arn) | KMS Key ARN for EBS encryption. If null, uses the default AWS managed key. | `string` | `null` | no |
...
| <a name="input_vpc_cidr_block"></a> [vpc\_cidr\_block](#input\_vpc\_cidr\_block) | CIDR block of the VPC for ingress rules | `string` | n/a | yes |
